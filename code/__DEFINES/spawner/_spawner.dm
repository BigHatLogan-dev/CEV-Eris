...
#define SPAWN_ABERRANT_ORGAN_ROACH "aberrant_organ_roach"
...
#define SPAWN_TAG_ABERRANT_ORGAN_ROACH MERGE_SPAWN_TAGS(SPAWN_TAG_ITEM, SPAWN_ABERRANT_ORGAN_ROACH)
